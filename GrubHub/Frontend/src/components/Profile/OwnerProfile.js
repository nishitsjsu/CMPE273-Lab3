...
import { UpdateOwnerMutation } from '../../mutation/mutations'
...
class OwnerProfile extends Component {
  ...
  submitUpdate = e => {
    ...
    //   }
    // });
    this.props.UpdateOwnerMutation({
      variables: {
        email: this.state.email,
  ...
  componentDidMount() {
    ...
    this.props.client.query({
      ...
      console.log("get ownerprofile", response);
      this.setState({
        username: response.data.getOwnerProfile[0].name,
        email: response.data.getOwnerProfile[0].email,
        phone: response.data.getOwnerProfile[0].phone,
        restaurant: response.data.getOwnerProfile[0].restaurantname,
        cuisine: response.data.getOwnerProfile[0].cuisine,
...
// export default graphql(getOwnerProfile)(OwnerProfile);
// export default withApollo(OwnerProfile);
export default compose(
  withApollo,
  graphql(getOwnerProfile, { name: "getOwnerProfile" }),

...
class AddItem extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            authFlag: false,
            emailcoookie: cookie.load("email"),
            restaurant: cookie.load("restaurantname"),
            cuisine: cookie.load("cuisine")
        };
    ...
    submitUpdate = e => {
        ...
        this.props.AddItemMutation({
            variables: {
                ...
                description: this.state.description,
                price: this.state.price,
                sectionname: this.state.sectionid,
                itemimage: this.state.itemimage,
                owneremail: this.state.emailcoookie,

...
class Login extends Component {
  ...
  submitLogin = e => {
    ...
    this.props.LoginMutation({
      ...
      if (this.state.radio === "owner") {
        cookie.save("email", this.state.username)
        cookie.save("cookie", this.state.radio)
        cookie.save("restaurantname", res.data.login.restaurantname)
        cookie.save("cuisine", res.data.login.cuisine)
        window.location.replace('/ownerhome')
      } else if (this.state.radio === "buyer") {
        cookie.save("email", this.state.username)
        cookie.save("cookie", this.state.radio)
        window.location.replace('/buyerhome')
      }
